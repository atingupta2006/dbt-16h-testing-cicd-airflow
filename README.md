...
| `handouts/e2e-production-walkthrough.md` | End-to-end walkthrough (E1–E7 with checkpoints) |
...
3. CI/CD: `handouts/cicd-and-deployment.md`. Airflow: `handouts/airflow-dags.md`.  
